...
(function () {
    ...
    function getInfoDiv(block) {
        // Gradio's Info.svelte always renders a single top-level
        // `.info-text` div per field block, regardless of how deep it's
        // nested (bare block, label-as-block, or a .container wrapper) --
        // unlike hash-based scope classes, `.info-text` is a stable static
        // class name, so a plain descendant lookup is enough.
